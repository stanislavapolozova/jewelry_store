                ...
                <div className="container">
                    ...
                    <div className="categories__grid">
                        <Link to="/catalog?category=necklaces" className="category-card">
                            <img src="/images/necklace1.jpg" alt="Ожерелья" className="category-card__image" />
                        ...
                        <Link to="/catalog?category=bracelets" className="category-card">
                            <img src="/images/bracelet1.jpg" alt="Браслеты" className="category-card__image" />
                            <h3 className="category-card__title">Браслеты</h3>
                            <p>Изящность мысли</p>
                        </Link>
                        <Link to="/catalog?category=earrings" className="category-card">
                            <img src="/images/earrings1.jpg" alt="Серьги" className="category-card__image" />
